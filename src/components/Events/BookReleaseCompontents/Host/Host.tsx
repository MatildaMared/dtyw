...
const Host: React.FC<HostProps> = ({ onButtonClick }) => {
	const bioContent = (
		<>
			...
			<p>
				Idag hjälper jag företagare att bygga med mer klarhet, mer kraft och mer kontroll, så att företaget inte bara ser bra ut utifrån utan faktiskt går att leva i också.
			</p>
			<p>
				Det är också därför jag skrev Den hållbara företagaren.
			</p>
		</>
	);
