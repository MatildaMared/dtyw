...
const WebinarTack: React.FC = () => {
	...
	const handleGoogleCalendarClick = () => {
		window.open('https://calendar.google.com/calendar/render?action=TEMPLATE&dates=20251112T180000Z%2F20251112T193000Z&details=Ett%20webinar%20f%C3%B6r%20dig%20som%20driver%20f%C3%B6retag%20vid%20sidan%20om%20jobbet%20%E2%80%93%20och%20vill%20satsa%20p%C3%A5%20ditt%20f%C3%B6retag%20utan%20att%20br%C3%A4nna%20ut%20dig%20sj%C3%A4lv&location=https%3A%2F%2Fus02web.zoom.us%2Fj%2F86023865294&text=Fr%C3%A5n%20stressad%20deltidsf%C3%B6retagare%20till%20ett%20h%C3%A5llbart%20heltidsf%C3%B6retag', '_blank');
	};

	const handleOutlookCalendarClick = () => {
		window.open('https://outlook.live.com/calendar/0/action/compose?allday=false&body=Ett%20webinar%20f%C3%B6r%20dig%20som%20driver%20f%C3%B6retag%20vid%20sidan%20om%20jobbet%20%E2%80%93%20och%20vill%20satsa%20p%C3%A5%20ditt%20f%C3%B6retag%20utan%20att%20br%C3%A4nna%20ut%20dig%20sj%C3%A4lv&enddt=2025-11-12T20%3A30%3A00&location=https%3A%2F%2Fus02web.zoom.us%2Fj%2F86023865294&path=%2Fcalendar%2Faction%2Fcompose&rru=addevent&startdt=2025-11-12T19%3A00%3A00&subject=Fr%C3%A5n%20stressad%20deltidsf%C3%B6retagare%20till%20ett%20h%C3%A5llbart%20heltidsf%C3%B6retag', '_blank');
	};
		...
		<>
			...
			<div className={styles.container}>
					...
					<div className={styles.heroContent}>
						...
						<div className={styles.eventInfo}>
							<div className={styles.eventItem}>
								...
								<span className={styles.eventValue}>12 november</span>
							</div>
							<div className={styles.eventItem}>
				...
				<section className={styles.calendarSection}>
					<div className={styles.sectionContent}>
						...
						<p className={styles.manualInfo}>
							Du kan också skriva in det själv:
						</p>
						
						<div className={styles.manualEvent}>
							<strong>Tisdag 12 november kl. 19:00</strong><br/>
				...
				<section className={styles.footerSection}>
					<div className={styles.sectionContent}>
						<h3 className={styles.sectionTitle}>👋 Vi ses live den 12 november kl. 19:00</h3>
