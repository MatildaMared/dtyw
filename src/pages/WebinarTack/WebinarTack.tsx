...
const WebinarTack: React.FC = () => {
	...
	return (
		<>
			<Helmet>
				<title>Du är anmäld till webbinariet! - Do things your way</title>
				<meta
			...
			<div className={styles.container}>
				<section className={styles.heroSection}>
					<div className={styles.heroContent}>
						...
						<p className={styles.introText}>Här är 3 saker du kan göra redan nu:</p>
					</div>
				</section>
				...
				<section className={styles.videoSection}>
					<div className={styles.sectionContent}>
						...
						<p className={styles.videoDescription}>
							...
							hur du kan förändra din <strong>stressrespons för alltid</strong>
							<br />
							och använda stress som <strong>din största källa till kraft och fokus</strong>.
						</p>

						<p className={styles.chatgptNote}>
							När jag förklarade hemligheten för ChatGPT så uppskattade den att{" "}
							<em>99 % inte känner till detta.</em>
						</p>
				...
				<section className={styles.calendarSection}>
					<div className={styles.sectionContent}>
						...
						<div className={styles.buttonContainer}>
							<Button onClick={handleGoogleCalendarClick}>Lägg till i Google Kalender</Button>
							<Button onClick={handleOutlookCalendarClick}>Lägg till i Outlook</Button>
						</div>

						<p className={styles.manualInfo}>Du kan också skriva in det manuellt:</p>

						<div className={styles.manualEvent}>
							<strong>Tisdag 22 oktober kl. 19:00</strong>
							<br />
				...
				<section className={styles.footerSection}>
					<div className={styles.sectionContent}>
						...
						<p className={styles.footerText}>
							...
							och gör dig redo för 90 minuter som ger dig{" "}
							<strong>
								kraften, lugnet och strukturen du behöver för att bygga upp ditt företag – och
								äntligen bli fri.
							</strong>
						</p>
